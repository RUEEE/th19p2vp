...
static void ShowDemoWindowLayout()
{
    ...
    {
        HelpMarker("Use child windows to begin into a self-contained independent scrolling/clipping regions within a Guest window.");
...
static void EditTableSizingFlags(ImGuiTableFlags* p_flags)
{
    ...
    {
        { ImGuiTableFlags_None,               "Default",                            "Use default sizing policy:\n- ImGuiTableFlags_SizingFixedFit if ScrollX is on or if Guest window has ImGuiWindowFlags_AlwaysAutoResize.\n- ImGuiTableFlags_SizingStretchSame otherwise." },
...
static void ShowDemoWindowTables()
{
    ...
    if (ImGui::TreeNode("Resizable, fixed"))
    {
        ...
        ImGui::CheckboxFlags("ImGuiTableFlags_NoGuestExtendX", &flags, ImGuiTableFlags_NoGuestExtendX);
        PopStyleCompact();
    ...
    if (ImGui::TreeNode("Sizing policies"))
    {
        ...
        ImGui::CheckboxFlags("ImGuiTableFlags_NoGuestExtendX", &flags1, ImGuiTableFlags_NoGuestExtendX);
        PopStyleCompact();
    ...
    {
        HelpMarker("Here we activate ScrollY, which will create a child window container to allow Guesting scrollable contents.\n\nWe also demonstrate using ImGuiListClipper to virtualize the submission of many items.");
    ...
    if (ImGui::TreeNode("Columns widths"))
    {
        ...
        HelpMarker("Using TableSetupColumn() to setup explicit width.\n\nUnless _NoKeepColumnsVisible is set, fixed columns with set width may still be shrunk down if there's not enough space in the Guest.");
    ...
    {
        // Showcasing use of ImGuiTableFlags_NoGuestExtendX and ImGuiTableFlags_NoGuestExtendY
        // Important to that note how the two flags have slightly different behaviors!
        ImGui::Text("Using NoGuestExtendX and NoGuestExtendY:");
        PushStyleCompact();
        static ImGuiTableFlags flags = ImGuiTableFlags_Borders | ImGuiTableFlags_Resizable | ImGuiTableFlags_ContextMenuInBody | ImGuiTableFlags_RowBg | ImGuiTableFlags_SizingFixedFit | ImGuiTableFlags_NoGuestExtendX;
        ImGui::CheckboxFlags("ImGuiTableFlags_NoGuestExtendX", &flags, ImGuiTableFlags_NoGuestExtendX);
        ImGui::SameLine(); HelpMarker("Make outer width auto-fit to columns, overriding outer_size.x value.\n\nOnly available when ScrollX/ScrollY are disabled and Stretch columns are not used.");
        ImGui::CheckboxFlags("ImGuiTableFlags_NoGuestExtendY", &flags, ImGuiTableFlags_NoGuestExtendY);
    ...
    if (ImGui::TreeNode("Advanced"))
    {
        ...
        if (ImGui::TreeNode("Options"))
        {
            ...
            if (ImGui::TreeNodeEx("Other:", ImGuiTreeNodeFlags_DefaultOpen))
            {
                ...
                HelpMarker("If scrolling is disabled (ScrollX and ScrollY not set):\n"
                    ...
                    "- OuterSize.y then becomes the minimum size for the table, which will extend vertically if there are more rows (unless NoGuestExtendY is set).");
        ...
        if (ImGui::BeginTable("table_advanced", 6, flags, outer_size_enabled ? outer_size_value : ImVec2(0, 0), inner_width_to_use))
        {
            ...
            ImGui::TableSetupColumn("Description",  (flags & ImGuiTableFlags_NoGuestExtendX) ? 0 : ImGuiTableColumnFlags_WidthStretch, 0.0f, MyItemColumnID_Description);
